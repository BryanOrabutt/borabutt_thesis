...
\begin{table}[ht]
 \centering
 \includegraphics[scale=.4,keepaspectratio=true]{../data/test_points.png}
...
\begin{figure}[htbp!]
 \centering
 \includegraphics[scale=.3,keepaspectratio=true]{../LTspice_Drawings/pseudo-nmos/pseudo-nmos.png}
